...
def load_movies():
    ...
    data = {
        ...
        "trailer":[
            "https://www.youtube.com/watch?v=XLUBcZQSZ70",
            "https://www.youtube.com/watch?v=_x-YLGv9u1g",
            "https://www.youtube.com/watch?v=q2aENKR59w4",
            "https://www.youtube.com/watch?v=q2aENKR59w4",
            "https://www.youtube.com/watch?v=INKMPPhPAPY",
            "https://www.youtube.com/watch?v=FYfjV31tE3o",
            "https://www.youtube.com/watch?v=8EPJiFfWRfw",
            "https://www.youtube.com/watch?v=fo9EhcwQXcM",
            "https://www.youtube.com/watch?v=8X3uF80H5LU",
            "https://www.youtube.com/watch?v=LzMyLV2pwws",
            "https://www.youtube.com/watch?v=gcHH34cEl3Y",
            "https://www.youtube.com/watch?v=afEJYg0tyJ4",
            "https://www.youtube.com/watch?v=aehhDN8p6Ws",
            "https://www.youtube.com/watch?v=mTy2Khuv_1s",
            "https://www.youtube.com/watch?v=Co6UqFUGJqU",
            "https://www.youtube.com/watch?v=Zi9ciWeJ3fg",
        ],
    }
...
EMOJI = {"Action":"sword","Romance":"heart","Comedy":"laugh","Drama":"masks",
         "Horror":"ghost","Animation":"sparkles","Biopic":"book","Family":"house",
         "Fantasy":"wizard","Sports":"trophy"}
    ...
    with st.sidebar.expander("My Watchlist", expanded=True):
        if st.session_state.watchlist:
            for title in list(st.session_state.watchlist):
                ...
                with c1:
                    if st.button(f"Play {title}", key=f"wlp_{title}"):
                        row = movies[movies["title"]==title]
                        if not row.empty:
                            st.session_state["playing"] = row.iloc[0].to_dict()
                            st.rerun()
                with c2:
                    if st.button("Del", key=f"wlr_{title}"):
...
if not st.session_state.logged_in:
    ...
    <div class="hero-banner">
        ...
        <div class="badge-row">
            ...
            <span class="badge">Voice Search</span>
...
if st.session_state.active_tab == "Movies":
    ...
    # Voice Search with real microphone
    st.markdown("""
    <div class="voice-box">
        <div class="voice-label">Voice Search</div>
        <div style="color:#8899bb;font-size:11px;margin-top:3px;">Type below OR click Speak to use microphone</div>
        ...
        <div id="voice-status" style="color:#8899bb;font-size:11px;margin-top:6px;"></div>
    </div>
    <script>
    function startVoice() {
        var status = document.getElementById('voice-status');
        if (!('webkitSpeechRecognition' in window) && !('SpeechRecognition' in window)) {
            status.innerText = 'Voice not supported. Use Chrome browser.';
            return;
        }
    ...
    with sc1:
        voice_q = st.text_input("Search", value=st.session_state.voice_query,
    ...
    EMO = {"Action":"sword","Romance":"heart","Comedy":"smile","Drama":"film",
           "Horror":"ghost","Animation":"star","Biopic":"book","Family":"home",
           "Fantasy":"magic","Sports":"trophy"}
            ...
            with cols5[idx % 5]:
                ...
                if b64:
                    ...
                    st.markdown(
                        ...
                        f'justify-content:center;font-size:52px;">?</div>',
                        unsafe_allow_html=True)
                ...
                if in_wl:
                    if st.button("Remove Watchlist", key=f"rm_{row['movie_id']}"):
    ...
    if wl:
        ...
        if not w_genres.empty:
            ...
            <div style="background:#0d1a3a;border:1px solid #4f46e544;border-radius:10px;
                ...
                AI Insight: You love <b style="color:#e2e8f0">{top}</b> movies most.
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:4px;">
            <div>
                ...
                <div style="font-size:12px;color:#8899bb;">
                    Watch movies together with friends - share a 6-digit code and sync up in real time!
                </div>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
...
# ════════════════════════════════════════════════
    ...
    if not user_downloads:
        ...
        <div style="text-align:center;padding:48px 20px;color:#8899bb;">
            <div style="font-size:52px;margin-bottom:12px;">DL</div>
            ...
            with dl_cols[i % 5]:
                ...
                if b64:
                    ...
                    st.markdown(f'<div style="width:100%;aspect-ratio:2/3;'
                                ...
                                f'border-radius:10px;display:flex;align-items:center;'
                                f'justify-content:center;font-size:52px;">DL</div>',
                                unsafe_allow_html=True)
